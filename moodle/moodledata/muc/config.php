<?php defined('MOODLE_INTERNAL') || die();
 $configuration = array (
  'siteidentifier' => 'dd794bce74840e48a75f8c59fec95ef1',
  'stores' => 
  array (
    'default_application' => 
    array (
  ...
  array (
    ...
    'block_microsoft/onenotenotebook' => 
    array (
      'mode' => 2,
      'component' => 'block_microsoft',
      'area' => 'onenotenotebook',
      'selectedsharingoption' => 2,
      'userinputsharingkey' => '',
    ),
    'block_microsoft/groups' => 
    array (
      'mode' => 2,
      'component' => 'block_microsoft',
      'area' => 'groups',
    ...
    'repository_office365/unifiedfolderids' => 
    array (
      'mode' => 2,
      'component' => 'repository_office365',
      'area' => 'unifiedfolderids',
      'selectedsharingoption' => 2,
      'userinputsharingkey' => '',
    ),
    'repository_office365/unifiedgroupfolderids' => 
    array (
      'mode' => 2,
      'component' => 'repository_office365',
      'area' => 'unifiedgroupfolderids',
      'selectedsharingoption' => 2,
      'userinputsharingkey' => '',
    ),
    ...
    'repository_onenote/foldername' => 
    array (
      'mode' => 2,
      'component' => 'repository_onenote',
      'area' => 'foldername',
      'selectedsharingoption' => 2,
      'userinputsharingkey' => '',
    ),
