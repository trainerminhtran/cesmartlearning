...
/**
 * Strings for component 'auth', language 'vi', branch 'MOODLE_34_STABLE'
 *
 * @package   auth
...
$string['alternatelogin'] = 'Nếu bạn nhập một URL ở đây, nó sẽ được sử dụng làm trang đăng nhập cho trang này. Trang nên chứa mẫu có thuộc tính action được đặt là <strong>\'{$a}\'</strong> và các mục trả về <strong>username</strong> and <strong>password</strong>.<br />Hãy cẩn thận không nhập URL sai bởi có thể bạn sẽ tự khóa chính mình ra khỏi trang.<br />Để trống thiết lập này để sử dụng trang đăng nhập mặc định.';
...
$string['authloginviaemail_desc'] = 'Cho phép người dùng sử dụng tải khoản và địa chỉ email (nếu duy nhất) để đăng nhập trang.';
