...
/**
 * Strings for component 'block_rss_client', language 'vi', branch 'MOODLE_34_STABLE'
 *
...
$string['addnewfeed'] = 'Thêm bảng tin mới';
...
$string['couldnotfindloadrssfeed'] = 'Không thể tìm hoặc tải bảng tin RSS.';
...
$string['disabledrssfeeds'] = 'Các bảng tin RSS bị vô hiệu hóa';
$string['displaydescriptionlabel'] = 'Hiển thị phần mô tả của mỗi đường liên kết?';
$string['editafeed'] = 'Sửa bảng tin';
...
$string['enableautodiscovery'] = 'Kích hoạt tự động khám phá bảng tin?';
$string['enableautodiscovery_help'] = 'Nếu được kích hoạt, các bảng tin trên các trang web được tìm kiếm tự động, nếu http://docs.moodle.org được nhập thì http://docs.moodle.org/en/index.php?title=Special:RecentChanges&feed=rss sẽ được tìm thấy.';
...
$string['feedsconfigurenewinstance2'] = 'Nhấn biểu tượng sửa để thiết lập khối hiển thị bảng tin RSS.';
$string['feedupdated'] = 'Dòng tin đã được cập nhật';
$string['feedurl'] = 'URL bảng tin';
...
$string['rss_client:addinstance'] = 'Thêm khối bảng tin RSS từ xa';
...
$string['rss_client:myaddinstance'] = 'Thêm khối bảng tin RSS từ xa vào Nhà của tôi';
