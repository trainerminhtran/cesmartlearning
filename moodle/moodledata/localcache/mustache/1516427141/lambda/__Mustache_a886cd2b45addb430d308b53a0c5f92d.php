...
class __Mustache_a886cd2b45addb430d308b53a0c5f92d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section763e57925b38c58799dbaa573fce3f3e($context, $indent, $value);
        $buffer .= $indent . '        </tbody>
';
        $buffer .= $indent . '    </table>
';
...
';
    ...
    private function sectionFbcce4d85a9398749415057c34ef050d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section763e57925b38c58799dbaa573fce3f3e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionFbcce4d85a9398749415057c34ef050d($context, $indent, $value);
                $buffer .= $indent . '                    <td>
';
                // 'icon' section
